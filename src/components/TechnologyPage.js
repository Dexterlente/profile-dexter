...
const TechnologyPage = () => {
  return ( <FullScreenSection  minHeight="110vh" backgroundColor="black">
            <VStack spacing='40px'>
            ...
            <HStack spacing='100px'> 
                    ...
                    <div class="relative group">
                        <div className="absolute -inset-0.5 bg-gradient-to-r from-pink-600 to-purple-600 rounded-lg blur-xl opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
                        <Square size='130px'>                                                  
                            <img className="relative p-1 bg-black rounded-lg leading-none flex items-center divide-x divide-gray-600" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original-wordmark.svg" />               
                        </Square>
                        </div>
                    </Center>
                    <Center w='130px' h='130px'>
